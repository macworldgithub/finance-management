...
import RiskAssessmentInherentRiskScoringReport from "../reports/components/RiskAssessmentInherentRiskScoringReport";

export default function RiskAssessmentManagementReportPage() {
  const [activeTab, setActiveTab] = useState("1");

  const tabItems = [
    {
      key: "1",
      label: "Inherent Risk Scoring",
      children: <RiskAssessmentInherentRiskScoringReport />,
    },
  ];
