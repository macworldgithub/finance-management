...
// Risk Responses Assessment columns (Tab 26)
export const getRiskResponsesAssessmentColumns = (
  handlers?: any,
  editingKeys: string[] = [],
): ColumnsType<any> => {
  const dynamicColumns = [
    ...
    // Add scoring fields for assessment tab
    {
      title: "Control Objective Score",
      dataIndex: "controlObjectiveScore",
      key: "controlObjectiveScore",
      width: 200,
      render: (text: any, record: any) =>
        editingKeys.includes(record.key) ? (
          <input
    ...
    {
      title: "Control Ref Score",
      dataIndex: "controlRefScore",
      key: "controlRefScore",
      width: 200,
      render: (text: any, record: any) =>
        editingKeys.includes(record.key) ? (
    ...
    {
      title: "Control Definition Score",
      dataIndex: "controlDefinitionScore",
      key: "controlDefinitionScore",
      width: 200,
      render: (text: any, record: any) =>
        editingKeys.includes(record.key) ? (
          <input
    ...
    {
      title: "Control Description Score",
      dataIndex: "controlDescriptionScore",
      key: "controlDescriptionScore",
      width: 200,
      render: (text: any, record: any) =>
        editingKeys.includes(record.key) ? (
          <input
    ...
    {
      title: "Control Responsibility Score",
      dataIndex: "controlResponsibilityScore",
      key: "controlResponsibilityScore",
      width: 200,
      render: (text: any, record: any) =>
        editingKeys.includes(record.key) ? (
          <input
    ...
    {
      title: "Key Control Score",
      dataIndex: "keyControlScore",
      key: "keyControlScore",
      width: 200,
      render: (text: any, record: any) =>
        editingKeys.includes(record.key) ? (
    ...
    {
      title: "Zero Tolerance Score",
      dataIndex: "zeroToleranceScore",
      key: "zeroToleranceScore",
      width: 200,
      render: (text: any, record: any) =>
        editingKeys.includes(record.key) ? (
          <input
