...
export const getRiskResponsesColumnsMain = (
  handlers?: any,
  editingKeys?: string[]
  ...
  },
  {
    ...
    render: (text: any, record: DataType) => {
      if (editingKeys?.includes(record.key)) {
        const menu = buildMenu(riskResponseTypeOptions, (key) =>
  ...
  },
  {
    ...
    render: (text: string, record: DataType) =>
      renderEditableInput(text, record.key, "riskResponseDescription", handlers, editingKeys),
  },
  {
    ...
    width: 180,
    render: (text: string, record: DataType) =>
      renderEditableInput(text, record.key, "controlObjective", handlers, editingKeys),
  },
  {
    title: "Control Ref",
